...
# Official Repository: https://github.com/tamimhasan1280/tpanel
# ==============================================================================
...
RELEASE_URL="https://raw.githubusercontent.com/tamimhasan1280/tpanel/main/releases/tpanel-core-client.tar.gz"
TEMP_TAR=$(mktemp)
...
if curl -sSL -f -m 60 "${RELEASE_URL}" -o "${TEMP_TAR}"; then
    ...
    TEMP_DIR=$(mktemp -d)
    git clone --depth 1 https://github.com/tamimhasan1280/tpanel "${TEMP_DIR}"
